...
int size_1d_grid(const char *rule_name, int *level_ptr)
{
  int level;
  level = *level_ptr;
  return level;
...
int get_1d_grid(const char *rule_name, int *level_ptr, double *p, double *w)
{
...
int size_md_tensor_grid(const char *rule_name, int *dim_ptr, int *level_ptr)
{
  int dim, level, i, ngridpoints;
  int *multi_index;
...
int get_md_tensor_grid(const char *rule_name, int *dim_ptr, int *level_ptr, double **p, double *w)
{
  char gauss_str[] = "GAUSS";
  double wt;
...
int size_md_sparse_grid(const char *rule_name, int *dim_ptr, int *level_ptr)
{
  char gauss_str[] = "GAUSS";
  double wt;
...
int get_md_sparse_grid(const char *rule_name, int *dim_ptr, int *level_ptr, double **p, double *w)
{
  char gauss_str[] = "GAUSS";
  double wt;
  double *sparse_wts, *pt;
...
int write_1d_points_and_weights(const char *rule_name, int *level_ptr)
{
  char gauss_str[] = "GAUSS";
  double *p, *w;
  int i, level, res;
...
int write_tensor_points_and_weights(const char *rule_name, int *dim_ptr, int *level_ptr)
{
  char p_filename[100];
  char w_filename[100];
  char gauss_str[] = "GAUSS";
...
int write_sparse_points_and_weights(const char *rule_name, int *dim_ptr, int *level_ptr)
{
  char p_filename[100];
  char w_filename[100];
  char gauss_str[] = "GAUSS";
