...
template<class T>
inline const T &MAX_NR(const T &a, const T &b)
        {return b > a ? (b) : (a);}

inline float MAX_NR(const double &a, const float &b)
        {return b > a ? (b) : float(a);}

inline float MAX_NR(const float &a, const double &b)
        {return b > a ? float(b) : (a);}

template<class T>
inline const T &MIN_NR(const T &a, const T &b)
        {return b < a ? (b) : (a);}

inline float MIN_NR(const double &a, const float &b)
        {return b < a ? (b) : float(a);}

inline float MIN_NR(const float &a, const double &b)
        {return b < a ? float(b) : (a);}
